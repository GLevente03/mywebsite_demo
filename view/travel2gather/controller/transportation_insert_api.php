...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($receivedApiKey == $apiKey){
        ...
        try{
            $id = $insertion->insert("INSERT INTO transportation (trip_id, vehicle, depart_from, arrive_at, departure_time, arrival_time, notes, added_by) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", $trip_id, $vehicle, $depart_from, $arrive_at, $departure_time, $arrival_time, $notes, $added_by);
