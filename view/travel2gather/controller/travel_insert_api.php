...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($receivedApiKey == $apiKey){
        ...
        try{
            $trip_id = $insertion->insert("INSERT INTO trip (name, date_from, date_to) VALUES (?, ?, ?)", $name, $date_from, $date_to);
            foreach ($user_ids as $user_id) {
                $insertion->insert("INSERT INTO trip_user (trip_id, user_id) VALUES (?, ?)", $trip_id, $user_id);
            }
